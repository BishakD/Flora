  ...
  return (
    <main id="main-content">
        ...
        <div className="container-shell">
          ...
          <div className="mt-28 grid items-end gap-12 md:mt-40 md:grid-cols-[0.95fr_1.05fr] md:gap-16">
            <div>
              ...
              <BlurRevealImage src="/images/room-05.jpg" alt="A refined suite with draped windows and a chaise, an editorial placeholder for Flora" className="arch-frame mx-auto aspect-[0.76] w-[min(100%,390px)]" sizes="(min-width: 768px) 390px, 92vw" imageClassName="object-[55%_center]" />
            </div>
      ...
      <section className="bg-flora-cream pb-32 md:pb-48" aria-labelledby="location-title">
        <div className="container-shell grid items-center gap-12 lg:grid-cols-[0.94fr_1.06fr] lg:gap-20">
          <div className="lg:order-2">
            <BlurRevealImage src="/images/florence-rooftops.jpg" alt="Florentine rooftops and historic architecture, placeholder location photography" className="aspect-[0.92]" sizes="(min-width: 1024px) 520px, (min-width: 768px) 50vw, 92vw" imageClassName="object-center" />
          </div>
      ...
      <section id="rooms" className="botanical botanical-emphasis textured bg-flora-blush py-28 md:py-44">
        <div className="container-shell">
          ...
          <div className="mt-16 grid items-center gap-12 md:mt-20 md:grid-cols-[0.9fr_1.1fr] md:gap-16">
            <BlurRevealImage src="/images/room-01.jpg" alt="A Flora guest room with fresco-inspired colour and collected furniture" className="arch-frame mx-auto aspect-[0.76] w-[min(100%,390px)]" sizes="(min-width: 768px) 390px, 92vw" />
            <div>
          ...
          <div className="mt-24 md:mt-36">
            <BlurRevealImage src="/images/room-09.jpg" alt="An ornate palazzo passage, editorial hospitality placeholder" className="aspect-[1.78] w-full" sizes="(min-width: 1080px) 1080px, 94vw" imageClassName="object-[center_46%]" />
      ...
      <div className="relative bg-flora-navy">
        ...
        <section id="dining" className="botanical florence-art textured relative z-10 bg-flora-ice py-28 md:py-44">
          ...
          <div className="mt-12 grid items-center gap-12 md:mt-16 md:grid-cols-[0.92fr_1.08fr] md:gap-16">
            <BlurRevealImage src="/images/dining-02.jpg" alt="A blue-toned restaurant salon, placeholder for Flora dining" className="arch-frame mx-auto aspect-[0.76] w-[min(100%,390px)]" sizes="(min-width: 768px) 390px, 92vw" />
            <div>
          ...
          <div className="pt-32 md:pt-48">
            ...
            <div className="mt-14 grid items-center gap-10 md:grid-cols-[0.95fr_1.05fr] md:gap-16">
              <BlurRevealImage src="/images/dining-03.jpg" alt="An intimate restaurant interior with blue seating" className="aspect-[1.42]" sizes="(min-width: 768px) 520px, 92vw" />
              <div>
            ...
            <div className="mt-16 grid gap-5 md:grid-cols-[0.82fr_1.18fr] md:items-start">
              <BlurRevealImage src="/images/dining-06.jpg" alt="A candlelit dining detail" className="aspect-[1.05] md:mt-20" sizes="(min-width: 768px) 440px, 92vw" />
              <BlurRevealImage src="/images/dining-07.jpg" alt="An elegant restaurant table and lounge detail" className="aspect-[1.42]" sizes="(min-width: 768px) 620px, 92vw" />
            </div>
          </div>
          ...
          <div className="pt-32 md:pt-48">
            <div className="relative mx-auto max-w-[880px] pt-16">
              ...
              <BlurRevealImage src="/images/florence-dusk.jpg" alt="Florence at blue hour, rooftop restaurant placeholder" className="aspect-[1.58]" sizes="(min-width: 880px) 880px, 92vw" />
            </div>
      ...
      <section className="bg-flora-sage px-4 pt-4 md:px-8 md:pt-8" aria-label="Flora spa treatment room">
        <BlurRevealImage src="/images/spa-05.jpg" alt="Botanical oils and candlelight prepared for a Flora wellness ritual" className="mx-auto aspect-[2.08] max-w-[1400px]" sizes="(min-width: 1400px) 1400px, 96vw" imageClassName="object-[center_58%]" />
      </section>
      ...
      <section id="spa" className="botanical florence-art textured bg-flora-sage py-28 md:py-44">
        <div className="container-shell">
          ...
          <div className="mt-14 grid items-center gap-12 md:grid-cols-[0.9fr_1.1fr] md:gap-16">
            <BlurRevealImage src="/images/spa-palazzo.jpg" alt="A softly illuminated arched treatment room in pale mineral plaster" className="arch-frame mx-auto aspect-[0.76] w-[min(100%,390px)]" sizes="(min-width: 768px) 390px, 92vw" />
            <div>
      ...
      <section className="botanical florence-art bg-flora-cream py-28 md:py-44">
        <div className="container-shell">
          ...
          <ParallaxImage src="/images/ponte-vecchio.jpg" alt="The Arno and Ponte Vecchio at golden hour" className="mt-10 aspect-[1.55] md:mt-14" sizes="(min-width: 1080px) 1080px, 92vw" />
          <div className="mx-auto mt-14 max-w-2xl text-center">
