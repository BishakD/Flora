 ...
 *  - Main content area
 */
export function ReceptionShell({ title, eyebrow = "Flora · Firenze", children }: ReceptionShellProps) {
        ...
        <div className="mx-auto max-w-[1440px] px-6">
          ...
          <div className="flex items-center justify-between gap-4 py-3">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/admin/login"
                className="hidden font-sans text-[0.62rem] uppercase tracking-[0.14em] text-flora-grey hover:text-flora-navy transition-colors sm:block"
              >
                Admin ↗
              </Link>
              <button
